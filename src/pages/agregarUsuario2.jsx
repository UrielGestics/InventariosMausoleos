...
<FormControl fullWidth>
  ...
  <FormControlLabel control={<Switch id="Pcatalogos" />} label="Catálogos" />
        ...
        <br />
        <Button  className={(mOscuro == 'true') ? 'btnMausoleosPrimaryDark' : 'btnMausoleosPrimaryLight'} style={{width: '100%'}} onClick={guardarDatosUsuario} size="large"><b>Guardar Y Regresar</b></Button>       
  </Box>
